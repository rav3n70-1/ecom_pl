        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div>
                <div class="flex items-center mb-4">
                    ...
                    <span class="ml-2 text-xl font-bold">ShopEase</span>
                </div>
                <p class="text-gray-300 mb-4">Your trusted online marketplace for quality products at great prices.</p>
            ...
            <div>
                ...
                <ul class="space-y-2">
                    ...
                    <li><a href="{{ route('products.index') }}" class="text-gray-300 hover:text-white transition">All Products</a></li>
                    <li><a href="#" class="text-gray-300 hover:text-white transition">Categories</a></li>
                    <li><a href="#" class="text-gray-300 hover:text-white transition">Flash Sale</a></li>
            ...
            <div>
                ...
                <p class="text-gray-300 mb-4">Subscribe to get special offers, free giveaways, and once-in-a-lifetime deals.</p>
                <form class="mb-4">
                    <div class="flex">
                        <input type="email" placeholder="Enter your email" class="flex-1 px-4 py-2 rounded-l-lg bg-gray-800 text-white border border-gray-700 focus:outline-none focus:ring-2 focus:ring-indigo-500">
                        <button type="submit" class="px-6 py-2 bg-indigo-600 text-white rounded-r-lg hover:bg-indigo-700 transition">Subscribe</button>
                    </div>
                </form>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <div class="flex flex-col md:flex-row justify-between items-center">
                <div class="flex items-center space-x-6 mb-4 md:mb-0">
                    <span class="text-sm text-gray-300">We Accept:</span>
                    <div class="flex items-center space-x-3">
                        <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/5/5e/Visa_Inc._logo.svg/1280px-Visa_Inc._logo.svg.png" alt="Visa" class="h-6 opacity-70">
                        <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/b/b7/MasterCard_Logo.svg/1280px-MasterCard_Logo.svg.png" alt="MasterCard" class="h-6 opacity-70">
                        <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/f/fa/American_Express_logo_%282018%29.svg/1280px-American_Express_logo_%282018%29.svg.png" alt="American Express" class="h-6 opacity-70">
                        <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/a/a4/Paypal_2014_logo.png/1280px-Paypal_2014_logo.png" alt="PayPal" class="h-6 opacity-70">
                    </div>
                </div>
                <div class="flex items-center space-x-6 text-sm">
                    ...
                    <a href="#" class="text-gray-300 hover:text-white transition">Cookies</a>
                </div>
            </div>
        </div>
    </div>
